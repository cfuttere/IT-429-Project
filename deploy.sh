...
EOF
    ...
    if [ "$DEPLOYMENT_TYPE" == "pdf2pdf" ]; then
        ...
        SOURCE_VERSION="Futterer"  # Use pdf2html-subtree since buildspec only exists there
...
deploy_ui() {
    ...
    if ! git clone -b updatedUI https://github.com/cfuttere/IT-429-Project-pdf2html-UI/tree/Futterer "$UI_TEMP_DIR" 2>/dev/null; then
...
GITHUB_URL="https://github.com/cfuttere/IT-429-Project.git".git"
