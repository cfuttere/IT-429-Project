...
EOF
    ...
    if [ "$DEPLOYMENT_TYPE" == "pdf2pdf" ]; then
        ...
        SOURCE_VERSION="Mohamed"  # Use Mohamed since buildspec only exists there
...
deploy_ui() {
    ...
    if ! git clone -b updatedUI https://github.com/cfuttere/IT-429-Project-pdf2html-UI.git "$UI_TEMP_DIR" 2>/dev/null; then
